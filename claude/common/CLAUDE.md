...
The following category-specific instruction files are available for use by Claude Code:

### When Writing Code

- [instructions/coding.md](instructions/coding.md)
    - Apply when writing, modifying, or reviewing code
    - Contains code quality guidelines, error handling patterns, code organization
    - Defines naming conventions, testing approach, and security best practices

### When Conducting Research

- [instructions/research.md](instructions/research.md)
...
- [instructions/docker.md](instructions/docker.md)
