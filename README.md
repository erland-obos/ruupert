...
This repository provides standardized instructions, best practices, and configuration templates for AI agents. It enables consistent, high-quality AI-assisted development workflows.

## What's Inside

### Core Agent Control
- **CLAUDE.md**: Main instruction file defining agent behavior, operational rules, and communication protocols
...
1. **Global rules** (CLAUDE.md): Always apply
